export function datePicker(callback, params) {
  const flatpickrInstances = {}
  
  function getDate(minus_day) {
    var today = new Date();
    var minusDaysAgo = new Date(today.getTime() - (minus_day * 24 * 60 * 60 * 1000));
    var ddMinusDaysAgo = String(minusDaysAgo.getDate()).padStart(2, '0');
    var mmMinusDaysAgo = String(minusDaysAgo.getMonth() + 1).padStart(2, '0');
    var yyyyMinusDaysAgo = minusDaysAgo.getFullYear();
  
    return `${ddMinusDaysAgo}-${mmMinusDaysAgo}-${yyyyMinusDaysAgo}`;
  }
  
    const input = document.getElementById("datepicker");
    flatpickrInstances['datepicker'] = flatpickr("#datepicker", {
      mode: "range",
      dateFormat: "d.m.Y",
      defaultDate: [getDate(0), getDate(14)],
      locale: "ru",
      showMonths: 3,
  ...
  `,
    ...
    function addCustomDateRangeMenu(instance) {
      ...
      applyButton.addEventListener("click", function () {
        const selectedDates = flatpickrInstances['datepicker'].selectedDates;
        ...
        if (
          ...
          params.end_date = selectedDates[0]
        ...
        flatpickrInstances['datepicker'].close();
      });
      
      cancelButton.addEventListener("click", function () {
        document.querySelector("#datepicker").value = "";
        flatpickrInstances['datepicker'].clear();
      });
    }
    ...
    function setRange(range) {
      ...
      flatpickrInstances['datepicker'].setDate([startDate, endDate], true);
    }
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    flatpickrInstances['datepicker-pop'] = flatpickr("#datepicker-pop", {
      mode: "range",
      dateFormat: "d.m.Y",
      locale: "ru",
      showMonths: 3,
  ...
  `,
    ...
    function addCustomDateRangeMenu(instance) {
      ...
      applyButton.addEventListener("click", function () {
        const selectedDates = flatpickrInstances['datepicker-pop'].selectedDates;
        ...
        flatpickrInstances['datepicker-pop'].close();
      });
  
      cancelButton.addEventListener("click", function () {
        document.querySelector("#datepicker").value = "";
        flatpickrInstances['datepicker-pop'].clear();
      });
    }
    ...
    function setRange(range) {
      ...
      flatpickrInstances['datepicker-pop'].setDate([startDate, endDate], true);
    }
